...
| Incoming issue, feature request, bug report, or external PR needs classification | `.agents/workflows/triage.md` |
| Triage result, PRD slice, or request should become a repo-local issue draft | `.agents/workflows/local-issue-draft.md` |
...
| Durable domain term is ambiguous, newly named, or contradicted by code | `.agents/skills/domain-modeling/SKILL.md` |
| Architecture health review before choosing a refactor | `.agents/workflows/improve-codebase-architecture.md` |
| Creating or substantially editing skills/workflows/routing docs | `docs/ai/skill-authoring.md` |
