---
description: Shared vocabulary for Pumni Web OS so agents name concepts, tests, and implementation seams consistently. Use before non-trivial planning, architecture discussion, feature naming, or when terminology is ambiguous.
---
