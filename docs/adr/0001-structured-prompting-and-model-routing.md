...
1. **Add structured prompting as optional, scoped guidance.** Create
   `docs/ai/prompt-structure.md` covering XML tagging and `<thinking>`. Scope it
...
2. **Add model routing as advisory guidance, not config.** Create
   `docs/ai/model-routing.md` with a task-type → model-class table. Pin no
...
- `docs/ai/prompt-structure.md`, `docs/ai/model-routing.md` — the deliverables.
