          ...
          {ACCENT_OPTIONS.map((opt) => (
            <div key={opt.name} data-accent={opt.name}>
              <button
                ...
                className="relative flex size-8 items-center justify-center rounded-full bg-primary transition-all duration-[var(--duration-fast)] hover:scale-110 active:scale-95 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background"
