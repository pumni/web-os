    ...
    <GlassSurface variant="panel" radius="full" className="flex items-center gap-1.5 px-3 py-1.5 select-none w-fit">
      {EMOJIS.map((emoji) => (
        <Button
          ...
          className="size-8 p-0 text-lg motion-safe:hover:bg-muted/80 hover:scale-125 transition-transform duration-[var(--duration-fast)] active:scale-95 rounded-full"
