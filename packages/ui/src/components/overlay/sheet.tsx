  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        style={mergedStyle}
        className={cn(
          'fixed flex glass-panel flex-col gap-4 data-[state=closed]:animate-out data-[state=closed]:duration-(--duration-base) data-[state=open]:animate-in data-[state=open]:duration-(--duration-slow)',
          // Inner-edge rounding only (the viewport-touching edges stay square):
          // sheets sit on the `rounded-xl` step of the radius ladder alongside
          // windows and the command palette (REFERENCE.md).
          side === 'right' &&
