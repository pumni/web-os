...
description: Build client TanStack Query reads and mutations without leaking server state into Zustand (`docs/conventions/data-fetching.md`). Use when adding client-driven async fetching, pagination, optimistic updates, or query-cache invalidation in a feature module. For client UI state only, use zustand-store.
---
...
- Do not mirror query results into Zustand (`docs/conventions/data-fetching.md`).
